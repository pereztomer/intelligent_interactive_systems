...
function App() {
  ...
  // Format feedback text with highlighted words (***text***)
  const formatFeedbackWithHighlights = (text) => {
    if (!text) return null
    
    // Split text by triple asterisks and create React elements
    const parts = []
    const regex = /\*\*\*(.*?)\*\*\*/g
    let lastIndex = 0
    let match
            ...
            <div className="attempt-details-section">
              ...
              {currentAttempt.geminiFeedback && (
                <div className="attempt-feedback-box">
                  ...
                  <div style={{ whiteSpace: 'pre-wrap', fontFamily: 'inherit', lineHeight: '1.8' }}>
                    {formatFeedbackWithHighlights(currentAttempt.geminiFeedback)}
                  </div>
                </div>
              )}
