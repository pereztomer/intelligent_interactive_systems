...
function App() {
  ...
  if (currentView === 'attempt') {
    ...
    const attemptNumber = currentAttempt && currentSession 
      ? currentSession.attempts?.indexOf(currentAttempt) + 1 
      : null
          ...
          {(currentSession || currentAttempt) && (
            <div className="session-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                {attemptNumber && (
                  <span style={{ color: '#4a5568', fontSize: '1.1rem', fontWeight: 500 }}>
