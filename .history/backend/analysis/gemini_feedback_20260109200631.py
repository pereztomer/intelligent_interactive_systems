...
"""
    ...
    prompt += f"""
Provide concise session-level analysis (max 400 words) focusing on:
1. Overall improvement trends across attempts
2. Persistent issues that need addressing
3. Areas showing progress
